        ...
        <main>
                    ...
                    <div class="services__style__two__wrap">
                        <div class="row gx-0">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon01.png" alt="">
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon02.png" alt="">
                                    </div>
                                    <div class="services__style__two__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon03.png" alt="">
                                    </div>
                                    <div class="services__style__two__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon05.png" alt="">
                                    </div>
                                    <div class="services__style__two__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon06.png" alt="">
                                    </div>
                                    <div class="services__style__two__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon04.png" alt="">
                                    </div>
                                    <div class="services__style__two__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/services_light_icon07.png" alt="">
                                    </div>
                                    <div class="services__style__two__content">
                                        <h3 class="title"><a href="services-details.html">Visual Design</a></h3>
                                        <p>Strategy is a forward-looking plan for your brand’s behavior.Strategy is a forward-looking plan.</p>
            ...
            <section class="testimonial testimonial__style__two">
                                        ...
                                        <div class="testimonial__content">
                                            ...
                                            <div class="testimonial__avatar">
                                                ...
                                                <div class="testi__avatar__img">
                                                    <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/images/testi_avatar01.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="testimonial__item">
                                        ...
                                        <div class="testimonial__content">
                                            ...
                                            <div class="testimonial__avatar">
                                                ...
                                                <div class="testi__avatar__img">
                                                    <img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/images/testi_avatar02.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="testimonial__two__icons">
                    <ul>
                        <li><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/testi_shape01.png" alt=""></li>
                        <li><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/testi_shape02.png" alt=""></li>
                        <li><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/testi_shape03.png" alt=""></li>
                        <li><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/testi_shape04.png" alt=""></li>
                        <li><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/testi_shape05.png" alt=""></li>
                        <li><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/icons/testi_shape06.png" alt=""></li>
                    </ul>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row gx-0 justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/blog/blog_post_thumb01.jpg" alt=""></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/blog/blog_post_thumb02.jpg" alt=""></a>
                                    <div class="blog__post__tags">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/img/icons/breadcrumb_icon01.png')  }}img/blog/blog_post_thumb03.jpg" alt=""></a>
                                    <div class="blog__post__tags">
