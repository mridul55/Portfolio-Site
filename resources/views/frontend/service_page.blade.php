...
<main>
    ...
    <section class="breadcrumb__wrap">
        ...
        <div class="breadcrumb__wrap__icon">
            <ul>
                <li><img src="{{ asset('frontend/assets/img/icons/breadcrumb_icon01.png.png') }}" alt=""></li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img src="{{ asset('frontend/assets/images/services_details01.jpg') }}" alt="">
                    </div>
                    <div class="services__details__content">
                        ...
                        <div class="services__details__img">
                            <div class="row">
                                <div class="col-sm-6">
                                    <img src="{{ asset('frontend/assets/images/services_details02.jpg') }}" alt="">
                                </div>
                                <div class="col-sm-6">
                                    <img src="{{ asset('frontend/assets/images/services_details03.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
