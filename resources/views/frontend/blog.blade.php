                    ...
                    <div class="standard__blog__post">
                        ...
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                <div class="thumb"><img src="{{ $item->blog_image }}" alt=""></div>
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                               @foreach ($categories as $cat)
                                <li class="sidebar__cat__item"><a href="{{ route('blog.details', $item->id) }}">{{ $cat->blog_category }} ({{ $cat->blogpost->count() }})</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="widget">
                            ...
                            <ul class="sidebar__comment">
                                <li class="sidebar__comment__item">
                                    <a href="{{ route('blog.details', $item->id) }}">Rasalina Sponde</a>
