            ...
            <form action="{{ route('update.portfolio') }}" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="id" value="{{ $editPortfolio->id }}">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="portfolio_name" id="name" value="{{$editPortfolio->portfolio_name}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="portfolio_title" id="title" value="{{$editPortfolio->portfolio_title}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea name="portfolio_description" id="elm1" >{{$editPortfolio->portfolio_description}}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    @endphp (!empty($editPortfolio->portfolio_image))
                              ? url($editPortfolio->portfolio_image)
                              : url('upload/no_image.jpg')--}} 
                    
                    src="{{ asset($editPortfolio->portfolio_image) }}"
                    alt="Card image cap">
                    </div>
                </div>
